...
public class MockServer implements ServerInterface {
    ...
    public MockServer() {
        ...
        Postcode postcode6 = new Postcode("SO16 3BL", restaurant);
        postcodes.add(postcode6);
        ...
        ServerWindow.getSupplierPostcodeMap().put(postcode1, supplier1.getName());
        ServerWindow.getSupplierPostcodeMap().put(postcode2, supplier2.getName());
        ServerWindow.getSupplierPostcodeMap().put(postcode3, supplier3.getName());

        Ingredient ingredient1 = addIngredient("Onion","grams",supplier1,1,5);
        Ingredient ingredient2 = addIngredient("Bread","grams",supplier2,1,5);
        Ingredient ingredient3 = addIngredient("Milk","grams",supplier3,1,5);

        ServerWindow.getIngredientSupplierMap().put(supplier1, ingredient1.getName());
        ServerWindow.getIngredientSupplierMap().put(supplier2, ingredient2.getName());
        ServerWindow.getIngredientSupplierMap().put(supplier3, ingredient3.getName());
    ...
    public User addUser(String name, String password, String address, Postcode postcode){
        User mockUser = new User(name, password, address, postcode);
    ...
    public Drone addDrone(Number speed) {
        ...
        mock.setDestination(postcodes.get(new Random().nextInt(postcodes.size()-1)));
    ...
    public void setRecipe(Dish dish, Map<Ingredient, Number> recipe) {
        ...
        for(Entry<Ingredient, Number> recipeItem : recipe.entrySet()) {
            System.out.println(recipeItem.getKey() + " " + recipeItem.getValue());
